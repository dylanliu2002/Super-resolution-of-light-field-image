...
def parse_args():
    ...
    parser.add_argument('--trainset_dir', type=str, default='E:\国防科大\LF-DFnet-master\LF-DFnet-master\Data')
    ...
    for idx_epoch in range(epoch_state, cfg.n_epochs):
        ...
        if idx_epoch % 1 == 0:
            ...
            save_ckpt({
                ...
                'loss': loss_list,},
                save_path='../checkpoint/', filename=cfg.model_name + '_' + str(cfg.upscale_factor) + 'xSR_' + str(cfg.angRes) +
