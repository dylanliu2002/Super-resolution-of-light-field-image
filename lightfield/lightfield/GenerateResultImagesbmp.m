...
resultsFolder = './benkeSR2 Results/';
...
for DatasetIndex = 1 : datasetsNum
    ...
    resultsFolder = ['./benkeSR2 Results/', DatasetName, '/'];
    ...
    for iScene = 1 : sceneNum
        ...
        for u = 1 : angRes
            for v = 1 : angRes                
                ...
                SavePath = ['./benkeSR2image/', DatasetName, '/', sceneName, '/'];
                if exist(SavePath, 'dir')==0
                    mkdir(SavePath);
                end
                imwrite(uint8(255*imgSR_rgb), [SavePath, num2str(u,'%02d'), '_', num2str(v,'%02d'), '.bmp' ]);
            end
        end        
    end
end
